...
- Cyclical firm
  ...
  - products are expenses, non-necessities
...
- Industry Classification System:(GICS, Russell Global Sectors, Industry Classification Benchmark by Dow Jones)
  - commercial classification: by products and service they provide
    - Basic materials and processing, consumer discretionary非必需消费品, consumer staples, energy, financial service, healthcare, industrial and producer durables工业和生产耐用品(defense国防, Aerospace航天...), real state(REITs), technology, telecommunications(wired and wireless service provider), utilities
...
- Five Force:
  - rivalry竞赛、对抗 among existing competitors
    ...
    - high fixed costs result in *price decreases*, owing to firm would like to *operate at full capacity*.
...
- 5 Stages:
  ...
  - growth
    ...
    - limited competitive pressures: grow without price competition, new entry threat comes to peak
  ...
  - mature
    ...
    - higher barrier to entry市场饱和: surviving firms have brand loyalty and low cost structures
