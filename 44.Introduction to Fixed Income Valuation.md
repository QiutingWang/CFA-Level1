...
- add-on yield
  ...
  - bank CDs, market reference rate, quoted as annualized add-on rates
  - calculation: Quoted add-on yield = HPY*365/days to maturity
    - HPY: holding period yield
      - HPY=(FV-PV)/PV
- discounted yield
  - issue at a discount price, pay par value at maturity
  - Treasury bills are quoted as it, based on 360-day per year
  - calculation: Quoted discounted yield=discount on the security*360/days to maturity
...
- Forward Rates↔︎Spot Rates
  - Calculation: $(1+S_2)^2=(1+S_1)(1+1y1y)$
